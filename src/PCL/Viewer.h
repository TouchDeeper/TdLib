...
namespace td{
    namespace pclib{
        ...
        public:
            ...
            const Eigen::Matrix4d transformations,ColorHandlerPointN scene_view_color, ColorHandlerPointN model_view_color, std::vector<int> window_size = std::vector<int>(2,0),double point_size = 1,std::vector<int> background_rgb = std::vector<int>(3,0));
        };
    }
