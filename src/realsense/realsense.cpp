...
//
//                    cloud->points[index_pcl].r = image.at<cv::Vec3b>(2*v,2*u)[2];
//                    cloud->points[index_pcl].g = image.at<cv::Vec3b>(2*v,2*u)[1];
//                    cloud->points[index_pcl].b = image.at<cv::Vec3b>(2*v,2*u)[0];
//
//                }
//            }
//
